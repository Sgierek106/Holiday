...
namespace PublicHoliday
{
    ...
    public class USACaliforniaPublicHoliday : PublicHolidayBase
    {
        ...
        /// <param name="year">The year.</param>
        /// <returns></returns>
        public static Holiday CesarChavezDay(int year)
        {
            var hol = new DateTime(year, 3, 31);
        ...
        /// <param name="year">The year.</param>
        /// <returns></returns>
        public static Holiday BlackFriday(int year)
        {
            var thanksgiving = Thanksgiving(year);
            var hol = thanksgiving.ObservedDate.AddDays(1);
            return new Holiday(hol, hol);
        }
        ...
        public override IList<DateTime> PublicHolidays(int year)
        {
            ...
            bHols.Add(CesarChavezDay(year)); // 31 March
            ...
            bHols.Add(BlackFriday(year)); //Day after Thanksgiving
        ...
        public override IDictionary<DateTime, string> PublicHolidayNames(int year)
        {
            ...
            bHols.Add(CesarChavezDay(year), "Cesar Chavez Day"); //Third Monday in February
            ...
            bHols.Add(BlackFriday(year), "Black Friday"); //Day after Thanksgiving
